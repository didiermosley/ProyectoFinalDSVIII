...
<body>
    ...
    <div class="container" align="center">
        ...
        <p>
            &nbsp;</p>
        <p>
            <asp:Button ID="Button1" runat="server" Text="Enviar" CssClass="btn" BorderStyle="Solid" />

        </p>
            <p>
                <span style="color: #97023b; font-weight: 900;">¿No tienes cuenta?</span><br />
                <asp:Button ID="p1" runat="server" Text="Registrarse" PostBackUrl="~/Login.aspx" BorderStyle="Solid" />
        </p>
    </form>
    </div>
